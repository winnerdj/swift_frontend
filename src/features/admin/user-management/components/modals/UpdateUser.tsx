    ...
    type CreateUserType = yup.InferType<typeof updateUserSchema>;


    const UpdateUser: React.FC<UpdateUserProps> = (props) => {
        // const context = useContext(UserContext)

        const [updateUser, updateUserProps] = useCreateUserMutation();
        ...
        // Ensure this return is outside handleSubmit
        return (
