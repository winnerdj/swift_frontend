...
const CreatePodTicket: React.FC<{
    ...
    // const [backendTicketData, setBackendTicketData] = useState<any | null>(null); // To store full ticket data from backend
    ...
    const handleFetchTripPlan = async (formData: FetchTripNumberType) => {
        ...
        try {
            ...
            if(response && response.data.length > 0) {
                ...
                formTicket.setValue('plateNo', response.data[0].plate_number || ''); // Ensure this matches ticket_plate_num if it's the same field
